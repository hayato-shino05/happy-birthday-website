...
| `Music` | ミュージックプレイヤー | Howler.js でバースデーソングやヴィンテージ楽曲を再生します。 |
...
| `Sparkles` | 13の祝祭日テーマ | お正月、花見、こどもの日、七夕、お盆、月見、文化の日、ハロウィン、クリスマスなどに対応します。 |
...
2. **思い出を残しやすくする（想い出箱）**
   - 写真、動画、音声、テキストメッセージ、フォトブース写真をまとめて保存できます。
